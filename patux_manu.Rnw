...
\begin{singlespace}
\title{{\bf {\Large Numerical and qualitative contrasts of two statistical models of water quality in tidal waters\footnote{\Sexpr{raw}}}}}
...
gamql <- c('good', 'poor', 'moderate', 'moderate', 'y', 'n', 'y', 'n', 'n')
