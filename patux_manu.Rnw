...
\begin{singlespace}
\title{{\bf {\Large Numerical contrasts and recommendations for use of two statistical models of water quality in tidal waters\footnote{\Sexpr{raw}}}}}
