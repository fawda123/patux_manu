...
qualt <- c('computational requirements', 'interpretation\\textsuperscript{2}', 'software', 'visualization', 'additional variables', 'censored data', 'confidence intervals', 'quantile fits')
consd <- c('p', 'p', 'p', 'p', 'dc/p', 'dc/p', 'p', 'p')
