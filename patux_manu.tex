...
\author{
  ...
  \vspace{1in} 
  \\ Version Date:   Fri Aug 7 15:46:40 2015 -0500
	}
\date{}
\maketitle
\end{singlespace}
...
%latex.default(tab, file = "", rowlabel = "Period", caption = cap.val,     caption.loc = "top", rgroup = c("All", "Annual", "Seasonal",         "Flow"), n.rgroup = c(1, rep(4, 3)), cgroup = c("Intercept",         "Slope", "Slope$'$"), n.cgroup = rep(2, 3), rowname = rows,     colheads = rep(c("LE1.2", "TF1.6"), 3), label = "tab:regpred")%
\begin{table}[!tbp]
...
%latex.default(tab, file = "", rowlabel = "Period", caption = cap.val,     caption.loc = "top", rgroup = c("All", "Annual", "Seasonal",         "Flow"), n.rgroup = c(1, rep(4, 3)), cgroup = c("Intercept",         "Slope", "Slope$'$"), n.cgroup = rep(2, 3), rowname = rows,     colheads = rep(c("LE1.2", "TF1.6"), 3), label = "tab:regnorm")%
\begin{table}[!tbp]
