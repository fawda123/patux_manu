...
\begin{singlespace}
\title{{\bf {\Large Numerical and qualitative contrasts of two statistical models for water quality change in tidal waters\footnote{Version Date:   Wed Jun 22 11:45:43 2016 -0500}}}}
...
%latex.default(tab, file = "", rowlabel = "Quality", caption = cap_val,     caption.loc = "top", rgroup = categ, n.rgroup = c(4, 4),     rowname = qualt, colheads = c("Consideration\\textsuperscript{1}",         "\\ac{GAM}", "\\ac{WRTDS}"), label = "tab:qualcomp",     insert.bottom = foots)%
\begin{table}[!tbp]
