...
\begin{singlespace}
\title{{\bf {\Large Comparison of weighted regression and additive models for trend evaluation of water quality in tidal waters\footnote{Version Date:   Tue Mar 22 10:33:21 2016 -0500}}}}
...
\hline
{\bfseries Flow}&&&&&&&&&&&\tabularnewline
~~Flow 1 (Low)&{\bf \textit{0.14}}&{\bf \textit{0.92}}&&-0.03&1.01&&{\bf \textit{0.46}}&{\bf \textit{0.77}}&&{\bf \textit{0.16}}&{\bf \textit{0.95}}\tabularnewline
~~Flow 2&0.00&1.00&&{\bf \textit{0.12}}&{\bf \textit{0.96}}&&{\bf \textit{0.14}}&{\bf \textit{0.94}}&&0.01&1.00\tabularnewline
~~Flow 3&0.09&0.96&&{\bf \textit{0.21}}&{\bf \textit{0.91}}&&{\bf \textit{0.12}}&{\bf \textit{0.96}}&&-0.02&1.00\tabularnewline
~~Flow 4 (High)&0.09&{\bf \textit{0.96}}&&0.03&{\bf \textit{0.97}}&&{\bf \textit{0.09}}&{\bf \textit{0.96}}&&{\bf \textit{0.09}}&{\bf \textit{0.95}}\tabularnewline
\hline
\end{tabular}\end{center}
