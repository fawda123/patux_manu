...
\author{
  ...
  \vspace{1in} 
  \\ Version Date:   Wed Aug 5 15:56:00 2015 -0500
	}
\date{}
\maketitle
\end{singlespace}
...
\caption[Comparison of \ac{WRTDS} and \acp{GAM} predictions of \ac{chla} by different time periods and station (LE1]{Comparison of \ac{WRTDS} and \acp{GAM} predictions of \ac{chla} by different time periods and station (LE1.2, TF1.6).  Time periods are annual groupings every seven years (top), seasonal groupings by monthly quarters (middle), and flow periods based on quantile distributions at each site (low).  Regression lines (thick) and 1:1 replacement lines (thin) are also shown.}\label{fig:wrtdsvgam}
\end{figure}
