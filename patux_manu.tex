...
\author{
  ...
  \vspace{1in} 
  \\ Version Date:   Wed Sep 23 16:14:31 2015 -0500
	}
\date{}
\maketitle
\end{singlespace}
...
%latex.default(tabLE12, file = "", rowlabel = "Station, Period",     caption = cap.val, caption.loc = "top", rgroup = c("All",         "Annual", "Seasonal", "Flow"), n.rgroup = c(1, rep(4,         3)), cgroup = c("GAM", "WRTDS"), n.cgroup = c(2, 2),     rowname = rows, colheads = rep(c("Ave.", "\\% Change"), 2),     label = "tab:trendsLE12")%
\begin{table}[!tbp]
...
\end{table}
%latex.default(tabTF16, file = "", rowlabel = "Station, Period",     caption = cap.val, caption.loc = "top", rgroup = c("All",         "Annual", "Seasonal", "Flow"), n.rgroup = c(1, rep(4,         3)), cgroup = c("GAM", "WRTDS"), n.cgroup = c(2, 2),     rowname = rows, colheads = rep(c("Ave.", "\\% Change"), 2),     label = "tab:trendsTF16")%
\begin{table}[!tbp]
