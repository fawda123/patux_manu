...
\author{
  ...
  \vspace{1in} 
  \\ Version Date:   Tue Aug 4 18:29:30 2015 -0500
	}
\date{}
\maketitle
\end{singlespace}
...
\caption[Patuxent River estuary with Chesapeake Bay inset]{Patuxent River estuary with Chesapeake Bay inset. Fixed locations monitored by the Chesapeake Bay Program at monthly frequencies are shown along the longitudinal axis with distance from the mouth (km). Salinity regions in the Patuxent for the larger Chesapeake Bay area are also shown (TF = tidal fresh, OH = oligohaline, MH = mesohaline).}\label{fig:map}
\end{figure}
