...
\author{
  ...
  \vspace{1in} 
  \\ Version Date:   Fri Oct 30 16:16:09 2015 -0500
	}
\date{}
\maketitle
\end{singlespace}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'se\_GAM' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'se\_GAM' not found}}\end{kframe}
\end{knitrout}
